...
\caption[]{\textit{left:} a 32x32 pixel phantom representing varying bone densities. \textit{right} corresponding sinogram with 64 projection angles. The lighter regions in the sinogram indicate higher photon counts.}
